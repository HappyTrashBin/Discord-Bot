# Бот для Discord на Python
## Взаимодействие с ботом
Бот поддерживает работу в конкретных каналах севрера, список этих каналов либо создаётся пользователем вручную, либо бот автоматически создаёт нужный файл.
